...
методы можно посмотреть в [документации](http://docs.python.org/py3k/reference/datamodel.html#specialnames).
...
можно сделать при помощи так называемой _управляющей последовательности_.
